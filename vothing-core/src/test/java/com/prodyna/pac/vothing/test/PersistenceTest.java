...
import com.prodyna.pac.vothing.api.service.*;
...
import com.prodyna.pac.vothing.core.model.UserImpl;
...
public class PersistenceTest {
	...
	public void testPersistence() {
		...
		// test roles
		Role adminRole = roleService.createRole(RoleConstants.ROLE_ADMIN, new ArrayList<>());
...
//		}
		...
		List<SurveyOptionRating> surveyOptionRatings3 = new ArrayList<>();
		...
		surveyOption1DB.setId(0);
		surveyOption2DB.setId(0);
		List<SurveyOption> surveyOptionList2 = new ArrayList<>();
