...
public class PerformanceEntry {
	 ...
	 *
	 * @param methodName Name of the method this performance entry is for.
	 * @param duration   First duration of the method invocation.
	 */
	 ...
	 *
	 * @param duration New duration for this method.
	 */
